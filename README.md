...
If the Use impersonation setting is on and cppcryptfs is running as administrator, then cppcryptfs will impersonate the calling user (e.g. you) before creating or opening files and directories.  This ensures that the user cannot access or modify files or directories that they do not have permissions for.
